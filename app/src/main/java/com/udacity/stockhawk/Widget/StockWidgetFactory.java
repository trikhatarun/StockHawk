...
/**
 * Created by trikh on 20-02-2017.
 */
...
public class StockWidgetFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        if (mCursor.moveToPosition(position)) {
            ...
            rv.setTextViewText(R.id.price,
                    dollarFormat.format(mCursor.getString(Contract.Quote.POSITION_PRICE)));
            rv.setTextViewText(R.id.name, mCursor.getString(Contract.Quote.POSITION_NAME));
    ...
    public void onDataSetChanged() {
        ...
        mCursor = db.query(Contract.Quote.TABLE_NAME,
                new String[]{Contract.Quote._ID, Contract.Quote.COLUMN_SYMBOL, Contract.Quote.COLUMN_NAME, Contract.Quote.COLUMN_PRICE,
