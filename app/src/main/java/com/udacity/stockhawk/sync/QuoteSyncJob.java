                ...
                if (stock == null) {
                    ...
                    if (name == null) {
                        ...
                        new Handler(Looper.getMainLooper()).post(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(context, context.getString(R.string.invalid_symbol, symbol), Toast.LENGTH_SHORT).show();
                            }
                        });
                        continue;
                    }
                    ...
                    for (HistoricalQuote it : history) {
                        ...
                        String dateFormatted = fmt.format(it.getDate().getTime());
                        historyBuilder.append(dateFormatted);
